...
export const histogramBucketSizes = [
  1e-9, 2e-9, 2.5e-9, 4e-9, 5e-9, 1e-8, 2e-8, 2.5e-8, 4e-8, 5e-8, 1e-7, 2e-7, 2.5e-7, 4e-7, 5e-7, 1e-6, 2e-6, 2.5e-6,
  4e-6, 5e-6, 1e-5, 2e-5, 2.5e-5, 4e-5, 5e-5, 1e-4, 2e-4, 2.5e-4, 4e-4, 5e-4, 1e-3, 2e-3, 2.5e-3, 4e-3, 5e-3, 1e-2,
  2e-2, 2.5e-2, 4e-2, 5e-2, 1e-1, 2e-1, 2.5e-1, 4e-1, 5e-1, 1, 2, 4, 5, 1e1, 2e1, 2.5e1, 4e1, 5e1, 1e2, 2e2, 2.5e2, 4e2,
  5e2, 1e3, 2e3, 2.5e3, 4e3, 5e3, 1e4, 2e4, 2.5e4, 4e4, 5e4, 1e5, 2e5, 2.5e5, 4e5, 5e5, 1e6, 2e6, 2.5e6, 4e6, 5e6, 1e7,
  2e7, 2.5e7, 4e7, 5e7, 1e8, 2e8, 2.5e8, 4e8, 5e8, 1e9, 2e9, 2.5e9, 4e9, 5e9,
];
/* eslint-enable */
