...
import { Average, UniqueCount, Count } from 'app/plugins/datasource/elasticsearch/dataquery.gen';
...
describe('Metric Editor', () => {
  ...
  it('Should not list special metrics', async () => {
    ...
    expect(await screen.findByText('Extende Stats')).toBeInTheDocument();
