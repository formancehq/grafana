...
import { Terms, BucketAggregation } from 'app/plugins/datasource/elasticsearch/dataquery.gen';
...
import { removeEmpty } from 'app/plugins/datasource/elasticsearch/utils';
